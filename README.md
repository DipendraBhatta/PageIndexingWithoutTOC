## DOCUMENT INDEXING AND RETRIEVAL SYSTEM (RAG) FOR SBC Document using Page Indexing RAG

This project provides a complete pipeline for parsing PDF documents, extracting semantic structures, building Page Index, and retrieving information through a query engine.
